...
import 'package:vgma/ArcChooser.dart';
import 'package:vgma/SmilePainter.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        backgroundColor: Color(0xFF010511),
        body: MyReviewPage(),
      ),
    );
  }
...
class _MyReviewPageState extends State<MyReviewPage>
  ...
  void initState() {
    ...
    var textStyle = TextStyle(color: Colors.orange, fontSize: 24.00, fontWeight: FontWeight.bold);

    badArcItem = ArcItem("I BORE", [Color(0xFFfe0944), Color(0xFFfeae96)], 0.0);
    ughArcItem = ArcItem("UGH", [Color(0xFFF9D976), Color(0xfff39f86)], 0.0);
    okArcItem = ArcItem(" E BE OKAY", [Color(0xFF21e1fa), Color(0xff3bb8fd)], 0.0);
    goodArcItem = ArcItem("AWESOME", [Color(0xFF3ee98a), Color(0xFF41f7c7)], 0.0);
        ...
        children: <Widget>[
          Center(
            child: Padding(
              ...
              child: Text(
                "\nHow would you rate this year\'s VGMA journey?",

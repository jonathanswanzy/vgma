...
import 'package:vgma/halloffame/Screens/DetailScreen/SKVDetailScreen.dart';
import 'package:vgma/pages/hallfame_page.dart';
import 'package:vgma/pages/nominations_page.dart';
import 'package:vgma/pages/rate_page.dart';
import 'package:vgma/pages/unsung_page.dart';
import 'package:vgma/theme/colors.dart';
import 'package:slimy_card/slimy_card.dart';

import 'package:vgma/halloffame/Screens/HomeScreen/SKVHomeScreen.dart';
import 'package:vgma/halloffame/Screens/DetailScreen/SKVDetailScreen.dart';
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                //MaterialPageRoute(builder: (context) => SKVHomeScreen()),
                                MaterialPageRoute(builder: (context) => HallfamePage()),
                              );
                            },
                            child: Container(
